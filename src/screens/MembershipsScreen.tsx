            ...
            return (
              <View key={plan.key} style={styles.planCard}>
                ...
                <View style={styles.planBody}>
                  ...
                  {founding ? (
                    // Plain sentence, not a boxed banner — this card never
                    // says FOUNDING 50 RATE anywhere else, so the label
                    // stays, just untangled from the heavier gold-box
                    // treatment that made the door read as repeating itself.
                    <>
